...
class sortByPrice implements Comparator<Product>
{
	...
	public int compare(Product other, Product another)
	{
		if (other.getPrice() > another.getPrice())
		{
			return 1;
		}
		else if (other.getPrice() < another.getPrice())
		{
			return -1;
		}
		else
...
{
	// Compares names of two products
	public int compare(Product other, Product another)
	{
		return other.getName().compareTo(another.getName());
	}
}
